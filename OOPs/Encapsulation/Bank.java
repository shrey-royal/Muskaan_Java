...
public class Bank {
    public static void main(String[] args) {
        ...
        BankAccount daughter = new BankAccount("987654321", "Muskan", 50000);


        System.out.println("Initial balances: ");
        System.out.println(father.getAccountHolderName() + ": " + father.getBalance());
        System.out.println(daughter.getAccountHolderName() + ": " + daughter.getBalance());

        Transaction transaction = new Transaction();
        transaction.transfer(father, daughter, 50000);
